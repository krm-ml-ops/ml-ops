...
Содержательные разделы РПД сохранены и перегруппированы для чтения в репозитории. В соответствии с требованиями разработки РПД на основе КРМ публикация дополнена таблицей пререквизитов и индикаторами ML-2.3 и LC-5.2; их дословные формулировки, уровни и связь с КИМ приведены в [`krm-alignment.md`](krm-alignment.md). Добавленные задания и тесты для этих индикаторов являются рабочей КРМ-надстройкой, а не изменением исходных файлов [`РПД-1.0.0.md`](../sources/rpd/md/РПД-1.0.0.md) и [`ФОС-1.0.1.md`](../sources/fos/md/ФОС-1.0.1.md).
