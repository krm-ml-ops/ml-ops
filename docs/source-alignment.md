...
- [`РПД-1.2.0.md`](../sources/rpd/md/РПД-1.2.0.md) - рабочая программа дисциплины
- [`ФОС-1.2.0.md`](../sources/fos/md/ФОС-1.2.0.md) - оценочные материалы для текущего контроля и промежуточной аттестации
...
РПД фиксирует `32` часа лабораторных работ, что соответствует ФОС и `ЛР-0.4.0.md`: `8 x 4 = 32` часа. Два часа КРС выделены на зачет, а самостоятельная работа уменьшена с `53` до `51` часа; общая трудоемкость `104` часа, состав лабораторных работ, официальные баллы, критерии и пороги не изменены. Эксплуатационные требования репозитория не изменяют официальные баллы, критерии и пороги.

## Сопоставление файлов

### РПД

- [`docs/rpd.md`](rpd.md) <- структурированная публикация [`РПД-1.2.0.md`](../sources/rpd/md/РПД-1.2.0.md)
...
Содержательные разделы РПД сохранены и перегруппированы для чтения в репозитории. Таблица пререквизитов, индикаторы ML-2.3 и LC-5.2, а также связанные с ними КИМ включены в актуальные исходные версии 1.2.0; их дословные формулировки, уровни и связь с КИМ приведены в [`krm-alignment.md`](krm-alignment.md). Дисциплина сохраняет четыре компетенции, а для LC-3 в КРМ доступен единственный индикатор LC-3.1.

### ФОС

- [`exam/theoretical-questions.md`](../exam/theoretical-questions.md) <- приложение № 1 и приложение № 6 [`ФОС-1.2.0.md`](../sources/fos/md/ФОС-1.2.0.md)
- [`exam/competence-tests.md`](../exam/competence-tests.md) <- приложение № 2 [`ФОС-1.2.0.md`](../sources/fos/md/ФОС-1.2.0.md)
- [`exam/current-control-practical-tasks.md`](../exam/current-control-practical-tasks.md) <- приложение № 3 [`ФОС-1.2.0.md`](../sources/fos/md/ФОС-1.2.0.md)
- [`exam/practical-tasks.md`](../exam/practical-tasks.md) <- приложение № 7 [`ФОС-1.2.0.md`](../sources/fos/md/ФОС-1.2.0.md)
- [`exam/grading.md`](../exam/grading.md) <- раздел 4 [`ФОС-1.2.0.md`](../sources/fos/md/ФОС-1.2.0.md) (регламент, пороги, распределение баллов, критерии)
- [`exam/assessment-map.md`](../exam/assessment-map.md) <- разделы 1-3 и приложение № 5 [`ФОС-1.2.0.md`](../sources/fos/md/ФОС-1.2.0.md)
- [`exam/README.md`](../exam/README.md) <- обзорная навигация по материалам [`ФОС-1.2.0.md`](../sources/fos/md/ФОС-1.2.0.md)
