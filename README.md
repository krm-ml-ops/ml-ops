...
Оригинальные учебные, методические и оценочные материалы лицензированы по [CC BY 4.0](LICENSE-CONTENT.md). Исполняемый baseline и другой оригинальный программный код лицензированы по [MIT](LICENSE-CODE.md). Правообладатель: Команда проекта «Основы MLOps». Архивные и внешние материалы сохраняют указанные в них условия использования.
